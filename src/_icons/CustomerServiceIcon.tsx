...
const CustomerServiceIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    <g
      ...
      strokeWidth={2}
      clipPath="url(#a)">
      <path d="M13.333 25a3.333 3.333 0 0 0-6.666 0v3.333a3.333 3.333 0 0 0 6.666 0V25ZM33.333 25a3.333 3.333 0 0 0-6.666 0v3.333a3.333 3.333 0 0 0 6.666 0V25Z" />
